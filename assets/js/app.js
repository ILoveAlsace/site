    ...
    app.innerHTML = `
      ...
      <section class="section compact">
        <div class="contact-grid">
          ...
          <article class="contact-card reveal"><h2>${esc(t("contact.directTitle"))}</h2><p>${esc(t("contact.directText"))}</p><div class="location-address"><strong>contact@pierresvives.com</strong><br><span>+33 (0) …</span></div></article>
        </div>
      </section>`;
